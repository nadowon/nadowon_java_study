...
public class 문자열_5 {
	...
	public static void main(String[] args) {
		...
		String s1=s.substring(6); // 6번부터 출력
		System.out.println(s1);
		String s2=s.substring(0,5); // 0번부터 4번까지 출력 
							//  -- 제외 endIndex-1
...
//		}
		...
		String s=addr.substring(0,addr.lastIndexOf("지번")); // 시작위치부터 "지번"전까지 출력
									// ----------- 문자 찾을 때
		System.out.println(s);
		/*
		 *  인덱스가 있는 위치값을 찾아오기
		...
		String ss=addr.substring(addr.lastIndexOf("서울")); // 맨 뒤 "서울"부터 출력
		System.out.println(ss);
		
		String str="Hello Java!!";
		String sss=str.replace("java", "Oracle"); // 안바뀜 대소문자 구분함
