 ...
 * 4. 생성자를 사용하지 않으면 자동 기본 생성자가 첨부된다
 * 5. 사용처
 ...
 *    new A()
 *    
 *    ***** 인스턴스메소드 : 인스턴스변수, 메소드, static 변수, static 메소드 전체를 사용이 가능
 *    ***** static메소드 : static 변수, static 메소드만 사용이 가능
 ...
 *       = 리턴형은 관계없다
 *     void aaa() ==============> aaa()
 *     int aaa(int a) ==========> aaa(int) → 같은 메소드로 인식하여 오류남
 *     double aaa(int a) =======> aaa(int)→↗
 *     double aaa(double a) ====> aaa(double)
